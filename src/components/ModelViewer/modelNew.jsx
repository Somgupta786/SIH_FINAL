...
//       // Generate 400 random colors
//       for (let i = 1; i <= 400; i++) {
//         console.log(rgbColor)
//         uniforms[`color${i}`] = { value: new THREE.Color(rgbColor[i]) };
//       }
...
//             .map((key) => `uniform vec3 ${key};`)
//             .join('\n')}
      
//           void main() {
//             float gradient = (vPosition.y + 50.0) / 100.0; // Normalize Y-axis
//             vec3 color = vec3(0.0);
      
//             // Example logic for using the first 3 colors
//             color = mix(color1, color2, gradient);
//             color = mix(color, color3, gradient * 0.5);
...
//       selectedMess.material[3] = gradientMaterial;
//       // for (let i = 1; i <= 4; i++) {
//       //   if (i === selectedDropdown3d) {
//       //     selectedMess.material[i].color.set(0xff0000); // Set color to red
//       //   } else {
